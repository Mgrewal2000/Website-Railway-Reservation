...
Invalid username try again<form action="insertReservation4.jsp" method="post"><br>

    Please enter your user name: <input type="text" name="username" required ><br>
    Please enter the name of your customer representative: <input type="text" name="customerRep" required><br>
    Please enter your reservation date(YYYY/MM/DD): <input type="date" name="date"required><br>
    Please enter the customer's trainschedule id : <input type="text" name="trainscheduleid"required><br>
