...
<% 
	...
	String updatetransitlinenameedit = request.getParameter("updatetransitlinename");
    ...
    if(rs.next()){
    	st.executeUpdate("update trainSchedule set transitLineName='" + updatetransitlinenameedit +"' where username='"+ userid+"'");
    	out.println("The new transitline has been updated<br>");
