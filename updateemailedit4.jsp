...
<% 
	...
	String updatenewemail = request.getParameter("newemail");
    ...
    if(rs.next()){
    	st.executeUpdate("update personCustomerEmployee set email='" + updatenewemail +"' where username='"+ userid+"'");
    	out.println("The new email has been updated<br>");
