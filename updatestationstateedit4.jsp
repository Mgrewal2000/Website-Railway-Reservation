...
<% 
	...
	String stationstate = request.getParameter("updatestationstateedit");
    ...
    if(rs.next()){
    	st.executeUpdate("update stations set stationState='" + stationstate +"' where username='"+ userid+"'");
    	out.println("The new station state has been updated<br>");
