...
<%
    ...
    if(rs.next()){
    	...
    	out.println("The train schedule information has been added. <a href='addTrainScheduleDB4.jsp'> Add another one?</a> OR  ");
    	out.println("<a href='RepresentativeSuccess4.jsp'>Return to the Admin page</a><br>");
    	
    	
    } else {
      
    	out.println("Invalid Reservation ID!! <a href='addTrainScheduleDB4.jsp'> Try again</a>");
